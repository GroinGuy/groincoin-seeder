...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Groincoin-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.groincoin.com", "seed2.groincoin.com", ""};
static const string testnet_seeds[] = {"testnet-seed1.groincoin.com",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 36968), true);
  }
  do {
